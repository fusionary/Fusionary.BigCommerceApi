...
public class BcProductsSearch : BcRequestBuilder<BcProductsSearch>
{
    ...
    public async Task<BcPagedResponse<TProduct>> SendAsync<TProduct>(CancellationToken cancellationToken) =>
        await Api.GetAsync<BcPagedResponse<TProduct>>(
