...
/// This converter can ONLY be applied to a property; setting it in options or on a type may cause a stack overflow
/// exception!
/// </summary>
...
public class SerializePropertyAsDefaultConverter<T> : JsonConverter<T>
{
    public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) =>
        JsonSerializer.Deserialize<T>(ref reader)!; // Ignore the incoming options!
