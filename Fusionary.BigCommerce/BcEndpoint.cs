...
public static class BcEndpoint
{
    ...
    public static string BrandMetafieldsV3(object brandId, object metafieldId) => $"v3/catalog/brands/{brandId}/metafields/{metafieldId}";
    ...
    public static string CategoryMetafieldsV3(object categoryId, object metafieldId) => $"v3/catalog/categories/{categoryId}/metafields/{metafieldId}";
    
    public static string CategoryProductSortOrderV3(object categoryId) => $"v3/catalog/categories/{categoryId}/products/sort-order";
    ...
    public static string ProductBulkPricingRulesV3(object productId) => $"v3/catalog/products/{productId}/bulk-pricing-rules";
